...
export default function Sidebar({ navItems, activeToolId, basePath }) {
    return (
        <div className="md:w-64 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 p-6 flex flex-col items-start gap-4 shadow-md md:fixed md:top-0 md:left-0 md:bottom-0 z-10 md:pt-20">

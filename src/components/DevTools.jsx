...
export default function DevTools() {
    // Estado para saber qué herramienta está seleccionada
    const [activeToolId, setActiveToolId] = useState(devTools[0].id);

    // Encuentra la herramienta activa basada en el estado
    const activeTool = devTools.find((tool) => tool.id === activeToolId);

    return (
        <div id="dev-tools" className="container mx-auto px-6 md:px-20 max-w-5xl pt-20 pb-12">
